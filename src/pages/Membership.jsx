      ...
      <div className="bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-900">Choose Your Fitness Journey</h1>
            <p className="mt-4 mx-auto text-xl text-gray-500">Select the membership that fits your goals and lifestyle</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex flex-col border-2 border-blue-500 rounded-lg shadow-lg relative w-full md:w-[calc(33.333%-22px)]">
              ...
              <div className="p-6 text-center border-b">
                ...
                <p className="mt-5 text-gray-500">For dedicated fitness enthusiasts</p>
              </div>
              <div className="p-6 flex-grow">
                <ul className="space-y-3">
                  <li className="flex">
            ...
            <div className="flex flex-col border-2 border-gray-200 rounded-lg w-full md:w-[calc(33.333%-22px)]">
              <div className="p-6 text-center border-b">
                ...
                <p className="mt-5 text-gray-500">Premium experience for serious athletes</p>
              </div>
              <div className="p-6 flex-grow">
                <ul className="space-y-3">
                  <li className="flex">
          ...
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-bold text-gray-900">All memberships include</h2>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <div className="bg-white p-6 rounded-lg shadow-sm w-full sm:w-[calc(50%-8px)] lg:w-[calc(25%-12px)]">
                ...
                <p className="mt-2 text-gray-500">Cancel anytime with no penalties</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm w-full sm:w-[calc(50%-8px)] lg:w-[calc(25%-12px)]">
                <h3 className="text-lg font-medium">Free WiFi</h3>
                <p className="mt-2 text-gray-500">Stay connected during your workout</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm w-full sm:w-[calc(50%-8px)] lg:w-[calc(25%-12px)]">
                <h3 className="text-lg font-medium">Fitness Assessment</h3>
                <p className="mt-2 text-gray-500">Track your progress with regular check-ins</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm w-full sm:w-[calc(50%-8px)] lg:w-[calc(25%-12px)]">
                <h3 className="text-lg font-medium">Community Events</h3>
                <p className="mt-2 text-gray-500">Join our fitness community activities</p>
              </div>
            </div>
          </div>
          ...
          {/* Questions Section */}
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-bold text-gray-900">Do you have any Questions?</h2>
            <p className="mt-4 text-lg text-gray-500">We're here to help you on your fitness journey</p>
            <div className="mt-8">
              <a href="/QandA" className="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md">
                Visit Our Q&A Page
              </a>
            </div>
          </div>
